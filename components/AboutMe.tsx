        ...
        <section className='text-white'>
            <div className='md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py:16'>
                ...
                <div className='mt-4 md:mt-0 text-center flex flex-col h-full'>
                    <h2 className='mb-8 md:mb-8 pointer-events-none whitespace-pre-wrap font-semibold leading-none text-transparent dark:from-white dark:to-black bg-gradient-to-b from-slate-500 to-gray-300 bg-clip-text text-6xl text-center mt-4'>About Me</h2>
                    <WordPullUp
